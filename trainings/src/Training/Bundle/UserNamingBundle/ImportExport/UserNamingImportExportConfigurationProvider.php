...
class UserNamingImportExportConfigurationProvider implements ImportExportConfigurationProviderInterface
{
    ...
    public function get(): ImportExportConfigurationInterface
    {
        return new ImportExportConfiguration([
            ...
            ImportExportConfiguration::FIELD_EXPORT_PROCESSOR_ALIAS => 'training.user_naming_type',
            ImportExportConfiguration::FIELD_IMPORT_PROCESSOR_ALIAS => 'training.user_naming_type'
        ]);
    }
}
